...
namespace WindowsApp
{
    class Program
    {
        static void Main(String[] args)
        {
            ...
            // Console.WriteLine(MorseCodeDecoder.Decode(".. -... .-. .- .... .. --    -- --- .... .- -- . -..")); // Added test call for MorseCodeDecoder
            // Console.WriteLine(MorseCodeEncoder.Encode("ibrahim mohamed")); // Added test call for MorseCodeEncoder
            // CountCharsinString.TestCountChars(); // Added test call for CountCharsinString
            Console.WriteLine(VowelsCounter.CountVowels("ibrahim"));
        }
    }
}